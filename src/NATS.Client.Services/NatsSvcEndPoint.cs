...
public class NatsSvcEndpoint<T> : NatsSvcEndpointBase
{
    ...
    public NatsSvcEndpoint(NatsConnection nats, string? queueGroup, string name, Func<NatsSvcMsg<T>, ValueTask> handler, string subject, IDictionary<string, string>? metadata, INatsDeserializer<T> deserializer, NatsSubOpts? opts, CancellationToken cancellationToken)
        ...
        ReadOnlySequence<byte> payloadBuffer)
    {
        ...
        try
        {
            msg = NatsMsg<T>.Build(subject, replyTo, headersBuffer, payloadBuffer, _nats, _nats.HeaderParser, _deserializer);
            exception = null;
        }
        catch (Exception e)
        {
