...
/// <see cref="ConsumerConfig.DeliverSubject"/>. Unlike some NATS client libraries,
/// this implementation requires <see cref="DeliverSubject"/> to be explicitly provided;
/// the library does not auto-generate an inbox. Use <see cref="INatsJSContext.NewBaseInbox"/>
/// to generate a unique subject when needed.
/// </remarks>
