...
public sealed class NatsSubscriptionManager : INatsSubscriptionManager, IAsyncDisposable
{
    private readonly ILogger<NatsSubscriptionManager> _logger;
    ...
    public NatsSubscriptionManager(NatsConnection connection, string inboxPrefix)
    {
        _connection = connection;
        _inboxPrefix = inboxPrefix;
        _logger = _connection.Opts.LoggerFactory.CreateLogger<NatsSubscriptionManager>();
