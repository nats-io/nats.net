...
internal static class Telemetry
{
    ...
    internal static KeyValuePair<string, object?>[] GetTags(string operation, INatsServerInfo? serverInfo, NatsPubOpts pubOpts)
    {
    ...
    internal static KeyValuePair<string, object?>[] GetTags(string operation, INatsServerInfo? serverInfo, NatsProOpts subOpts)
    {
        var tags = new List<KeyValuePair<string, object?>>()
        {
            new KeyValuePair<string, object?>(Constants.SystemKey, Constants.SystemVal),
