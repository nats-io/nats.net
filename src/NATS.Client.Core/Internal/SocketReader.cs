...
internal sealed class SocketReader
{
    ...
    private readonly INatsSocketConnection _socketConnection;

    private Memory<byte> _availableMemory;

    public SocketReader(INatsSocketConnection socketConnection, int minimumBufferSize, ConnectionStatsCounter counter, ILoggerFactory loggerFactory)
    {
