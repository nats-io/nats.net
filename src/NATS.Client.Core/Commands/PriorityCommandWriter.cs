...
internal sealed class PriorityCommandWriter : IAsyncDisposable
{
    ...
    public PriorityCommandWriter(NatsConnection connection, ObjectPool pool, INatsSocketConnection socketConnection, NatsOpts opts, ConnectionStatsCounter counter, Action<PingCommand> enqueuePing)
    {
