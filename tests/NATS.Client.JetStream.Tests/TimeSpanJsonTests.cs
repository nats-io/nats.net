...
public class TimeSpanJsonTests
{
    ...
    public void ConsumerConfigAckWait_test(string value, string expected)
    {
        ...
        serializer.Serialize(bw, new ConsumerConfig { AckWait = time }, null);
    ...
    public void ConsumerConfigIdleHeartbeat_test(string value, string expected)
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new ConsumerConfig { IdleHeartbeat = time }, null);
    ...
    public void ConsumerConfigInactiveThreshold_test(string value, string expected)
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new ConsumerConfig { InactiveThreshold = time }, null);
    ...
    public void ConsumerConfigMaxExpires_test(string value, string expected)
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new ConsumerConfig { MaxExpires = time }, null);
    ...
    public void ConsumerGetnextRequestExpires_test(string value, string expected)
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new ConsumerGetnextRequest { Expires = time }, null);
    ...
    public void ConsumerGetnextRequestIdleHeartbeat_test(string value, string expected)
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new ConsumerGetnextRequest { IdleHeartbeat = time }, null);
    ...
    public void PeerInfoActive_test(string value, string expected)
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new PeerInfo { Name = "test", Active = time }, null);
    ...
    public void StreamConfigMaxAge_test(string value, string expected)
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new StreamConfig { MaxAge = time }, null);
    ...
    public void StreamConfigDuplicateWindow_test(string value, string expected)
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new StreamConfig { DuplicateWindow = time }, null);
    ...
    public void StreamSourceInfoActive_test(string value, string expected)
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new StreamSourceInfo { Name = "test", Active = time }, null);
    ...
    public void StreamSourceInfoActive_minus_one_indicates_no_activity()
    {
        ...
        var resultMinusOne = serializer.Deserialize(new ReadOnlySequence<byte>(jsonWithMinusOne.ToArray()), null);
        Assert.NotNull(resultMinusOne);
        Assert.Null(resultMinusOne.Active);

        var jsonWithZero = """{"name":"test","lag":0,"active":0}"""u8;
        var resultZero = serializer.Deserialize(new ReadOnlySequence<byte>(jsonWithZero.ToArray()), null);
    ...
    public void StreamSourceInfoActive_null_roundtrip()
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new StreamSourceInfo { Name = "test", Active = null }, null);
        var json = Encoding.UTF8.GetString(bw.WrittenSpan.ToArray());
    ...
    public void ConsumerInfoPauseRemaining_test(string? value, string expected)
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new ConsumerInfo { StreamName = "test", Name = "test", PauseRemaining = time }, null);
    ...
    public void ConsumerConfigBackoff_test(int minimumFrameworkVersion, List<TimeSpan>? timeSpans, string expected)
    {
        ...
        var bw = new NatsBufferWriter<byte>();
        serializer.Serialize(bw, new ConsumerConfig { Backoff = timeSpans }, null);
